...
public static class GPURenderRegistry
{
    ...
    {
        // Meshes.Add(mesh);
        // infra.Config.Infra.EnsureMeshRelatedBuffersAreSized();
        ...
        // {
        //     var me = Meshes[i];
        //     ((MeshInfo*) Renderer2.infra.Config.VKRender.GlobalData.MeshInfoBufferPtr)[i] = new()
        //     {
    ...
    // {
    //     // return Renderer2.infra.Config.VKRender.GlobalData.indexBuffer.Upload(meshIndexBuffer);
    // }
    //
    // private static uint LoadVertices(DefaultVertex[] meshVertexBuffer)
    // {
    //     // return Renderer2.infra.Config.VKRender.GlobalData.vertexBuffer.Upload(meshVertexBuffer);
    // }
